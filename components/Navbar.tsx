...
const Navbar: React.FC<NavbarProps> = ({ currentView, setView, onOpenSettings }) => {
  ...
  const navLinks = [
    ...
    { label: "Dez's Story", value: PageView.ABOUT },
        ...
        <div className="flex justify-between h-16">
          <div className="flex items-center">
            ...
            >
              ...
              <span className="font-serif text-lg md:text-xl font-semibold text-slate-800 tracking-tight whitespace-nowrap">
                Crossing Over<span className="text-brand-600 font-normal text-xs md:text-sm ml-1">with Dez</span>
              </span>
            </button>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-1 md:space-x-2 lg:space-x-4">
            {navLinks.map((link) => (
              <button
                ...
                className={`px-1.5 lg:px-3 py-2 rounded-md text-[11px] lg:text-sm font-medium transition-colors duration-200 whitespace-nowrap ${currentView === link.value
